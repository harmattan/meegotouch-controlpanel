...
#ifndef DCPSTYLABLEWIDGET_H
#define DCPSTYLABLEWIDGET_H
 ...
 * actual GUI of the applet. The DcpStylableWidget is the base class for these views
 * (sometimes called pages).
 */

class DcpStylableWidget: public MStylableWidget
{
    Q_OBJECT
...
private:
    ...
    friend class Ut_DcpStylableWidget;
