...
**
** Created: Thu May 14 08:00:55 2009
...
const QMetaObject DateTimeWidget::staticMetaObject = {
    { &DcpWidget::staticMetaObject, qt_meta_stringdata_DateTimeWidget,
...
void *DateTimeWidget::qt_metacast(const char *_clname)
{
    ...
    return DcpWidget::qt_metacast(_clname);
}

int DateTimeWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = DcpWidget::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
